...
import '../../../theme/components/app_range_slider_theme.dart';
...
class AppRangeSlider extends StatelessWidget {
  ...
  /// Si es false, el slider se muestra deshabilitado.
  final bool enabled;

  String _defaultFormatter(double value) => value.round().toString();
